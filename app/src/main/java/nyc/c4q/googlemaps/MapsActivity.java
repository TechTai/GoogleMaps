...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker at C4Q and move the camera
        LatLng c4q = new LatLng(40.7429595, -73.9419215);
        mMap.addMarker(new MarkerOptions().position(c4q).title("Marker at C4Q").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_round)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(c4q));
